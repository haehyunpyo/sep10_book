...
function kakaoLogin(){
	...
	//window.open("https://kauth.kakao.com/oauth/authorize?client_id=***CLIENT_ID***&redirect_uri=http://localhost/login&response_type=code", "_blank", "width=500, height=500");
